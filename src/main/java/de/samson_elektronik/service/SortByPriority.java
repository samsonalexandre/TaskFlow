...
/**
 * Konkrete Strategie: sortiert Aufgaben nach Priorität, absteigend
 * (höchste Priorität zuerst). Nutzt den numerischen "level"-Wert
 * aus Priority, da Enums von sich aus nicht sortierbar sind.
 */
